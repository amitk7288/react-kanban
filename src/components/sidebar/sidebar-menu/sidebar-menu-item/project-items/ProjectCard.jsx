...
export default function ProjectCard({
  ...
  return (
    <div className="relative flex w-auto flex-col items-center justify-center gap-3 rounded-md border border-gray-200 bg-white p-4 shadow-lg sm:h-auto dark:border-drkbrd dark:bg-drkbg dark:text-drkcol">
      ...
      <div className="flex items-center gap-2">
        ...
        <p className={`text-center text-sm ${projectCompletion === 100 ? `font-semibold` : null}`}>{projectCompletion}% complete</p>
      </div>
      <Link
